...
import '../css/RawDataComponent.css';
import '../App.css';
...
function Raw_data({redirect}) {
  ...
  <>
    <div className="sub-banner">
        <button className="nav-button" onClick={handleModel}>Home</button> &gt; 
          ...
          <div className="list-sections">
            ...
            {activeSessionData.frames===undefined || !activeSession?
              ...
              <div class="rectangle" style={{width: "100%"}}>
                ...
                <label class="session-info">Juego serio: {activeSession.game}</label>
                <br></br>
              ...
              <PointsScene dataItems={selectedDataItems} activeSessionData={activeSessionData}></PointsScene>
              <button className="button-new-patient" onClick={handleModel}>
                Visualizar vista del modelo
              </button>
              
              <Tabs tabs={tabs} onTabChange={(i)=>handleTabChange(i,sessions)} />
              
              <h3 class="title">Gráfica comparativa</h3>
              {selectedDataItems.length>0 && (
                <>
